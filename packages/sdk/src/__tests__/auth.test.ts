...
//   - jjhjError hierarchy propagation with request-id passthrough
...
function client(fetchImpl: typeof fetch): jjhj {
  return new jjhj({ baseUrl: "https://api.test", fetch: fetchImpl });
}
...
describe("AuthClient", () => {
  ...
  it("client.auth is wired onto the jjhj class", () => {
