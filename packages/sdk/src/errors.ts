// Typed error hierarchy for the jjhj SDK.
//
...
// codes (forward compatibility) fall back to the generic `jjhjError`
...
export interface jjhjErrorInit {
 ...
 * `quota_exceeded`) decode to this class — `instanceof jjhjError`
 * still matches.
 */
export class jjhjError extends Error {
  ...
  constructor(init: jjhjErrorInit) {
...
export class BadRequestError extends jjhjError {
  constructor(init: jjhjErrorInit) {
    super(init);
...
export class UnauthenticatedError extends jjhjError {
  constructor(init: jjhjErrorInit) {
    super(init);
...
export class ForbiddenError extends jjhjError {
  constructor(init: jjhjErrorInit) {
    super(init);
...
export class NotFoundError extends jjhjError {
  constructor(init: jjhjErrorInit) {
    super(init);
...
export class ConflictError extends jjhjError {
  constructor(init: jjhjErrorInit) {
    super(init);
...
export class ValidationError extends jjhjError {
...
export class PreconditionFailedError extends jjhjError {
  constructor(init: jjhjErrorInit) {
    super(init);
...
export class UnsupportedError extends jjhjError {
  constructor(init: jjhjErrorInit) {
    super(init);
...
export class InternalError extends jjhjError {
  constructor(init: jjhjErrorInit) {
    super(init);
...
export interface RateLimitErrorInit extends jjhjErrorInit {
...
export class RateLimitError extends jjhjError {
...
/**
 * Decode an HTTP `Response` into the appropriate `jjhjError` subclass.
 *
 * Forward-compatible: unknown error codes resolve to the base `jjhjError`.
