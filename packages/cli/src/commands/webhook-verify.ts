// `jjhj webhook verify` — local cryptographic verification of a
// jjhj outbound webhook delivery (Task 0106).
//
...
//     command is usable on a fresh install with no `jjhj login`.
