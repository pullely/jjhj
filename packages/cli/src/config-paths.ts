...
//   - `~/.config/jjhj/credentials.json` (0600)
//   - `~/.config/jjhj/config.json`     (0644)
//
// Override via `JJHJ_CONFIG_DIR` (used heavily by tests).
...
export function resolveConfigDir(): string {
  ...
  // the dir they expect; fall back to `~/.config/jjhj` everywhere
