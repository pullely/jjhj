...
// `@saas/sdk` client class name (`jjhj`) is intentionally NOT part of
...
export const CLI_BIN = "jjhj";

/** Product/brand name used in human-facing CLI copy. */
export const PRODUCT_NAME = "jjhj";

/** Default API base URL when `--api-url` is not supplied. */
export const DEFAULT_API_URL = "https://api.jjhj.dev";
