 ...
 * signature verifier for jjhj outbound webhook deliveries.
 *
...
/**
 * Compute the canonical jjhj webhook signature for a payload.
...
/**
 * Verify the HMAC-SHA256 signature of a jjhj webhook delivery.
 *
